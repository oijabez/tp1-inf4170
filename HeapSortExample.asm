...
Tas_sort: # a0 = &tableau, a1 = taille(tableau)
  addi $sp, $sp, -12
  ...
  ble $a2,$zero, Tas_sort_Fin  # if (n <= 0 ) return;
...
Boucle_Tas_sort:
  ...
  addi $a2, $a2, -1 # n--
  jal descendre_bulle  # a0 = &tableau, a1 = 0, a2 = n
...
boucle_tas:
  jal descendre_bulle # a0 = &tableau, a1 = debout_indice, a2 = taille-1
  addi $a1, $a1, -1
...
descendre_bulle: 
  move $t0, $a1  
  sll $t1, $t0, 1  # enfant = index*2+1
  addi $t1, $t1, 1
  
  bgt $t1, $a2, finalizer_bulle_desc
...
Changement:
  ...
  ble $t6, $t4, finalizer_bulle_desc
  ...
  addi $t1, $t1, 1
  ble $t1, $a2, boucle_bulle_desc
  
finalizer_bulle_desc:
  jr $ra
